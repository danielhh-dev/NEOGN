const TopCategories = () => {
  return (
    <div className="w-auto flex justify-around items-center">
      <a href="https://neogn-back.up.railway.app/api/products/filter?category=Monitors">
      ...
      <a href="https://neogn-back.up.railway.app/api/products/filter?category=Headsets">
        <div className="w-[76px] h-[60px] rounded-xl border border-violet-200 flex flex-col justify-center items-center">
          <img
      ...
      <a href="https://neogn-back.up.railway.app/api/products/filter?category=Keyboards">
        <div className="w-[76px] h-[60px] rounded-xl border border-violet-200 flex flex-col justify-center items-center">
          <img
      ...
      <a href="https://neogn-back.up.railway.app/api/products/filter?category=Mice">
        <div className="w-[76px] h-[60px] rounded-xl border border-violet-200 flex flex-col justify-center items-center">
          <img
