  ...
  return (
    ...
    >
      <div className="w-full p-2 flex items-center justify-end">
        <input
          type="text"
          className={`z-300 bg-transparent rounded-full border flex-1 text-gray-500 focus:outline-none focus:border-blue-700 focus:ring px-4 transition duration-300 
          focus:ring-blue-300 ease-in-out shadow-sm  ${isFocused ? " ring ring-blue-200 shadow-md" : "hidden"}`}
