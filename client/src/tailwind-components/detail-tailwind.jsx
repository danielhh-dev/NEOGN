...
const DetailT = () => {
  ...
  return (
    <div className="relative w-[366px] h-[632px]">
      <div className="absolute w-[293px] h-[277px] top-0 left-[73px] bg-[#f6eaec] rounded-[20px_0px_0px_20px] overflow-hidden">
        <div className="relative w-[379px] h-[330px] top-[-26px] left-[-43px] bg-[url(thumbnails-large-default-upload-bucket-wh1000xm4b-0000-001-406fdd3cc9e49e28002ad8baef9185c8-1-1.png)] bg-cover bg-[50%_50%]">
          <div className="relative w-[42px] h-[42px] top-[39px] left-[280px]">
            <div className="inline-flex items-start gap-[10px] p-[9px] relative bg-absolutestaticwhite-s rounded-[10px] border border-solid border-oil-03">
            <img src="https://i.postimg.cc/Dy9pyQCB/Dark-heart-svgrepo-com.png" className="relative w-[24px] h-[24px]" color="#0D0D0D" />
            </div>
          </div>
        </div>
      </div>
      <div className="inline-flex items-start gap-[10px] absolute top-0 left-[4px] bg-absolutestaticwhite-s rounded-[12px] border-[1.5px] border-solid border-primary-color">
        <img
          className="relative w-[50px] h-[50px] object-cover"
          alt="Thumbnails large"
          src="thumbnails-large-default-upload-bucket-wh1000xm4b-0000-001-406fdd3cc9e49e28002ad8baef9185c8-1-2.png"
        />
      </div>
      <div className="inline-flex items-start gap-[10px] absolute top-[66px] left-[4px] bg-absolutestaticwhite-s rounded-[12px] border border-solid border-oil-03">
        <img
          className="relative w-[50px] h-[50px] object-cover"
          alt="F"
          src="f-3f-1e-4cde-7ef-05279-0bfd-6-4ce-8-5f-3-9bb.png"
        />
      </div>
      <div className="inline-flex items-start gap-[10px] absolute top-[132px] left-[4px] bg-absolutestaticwhite-s rounded-[12px] border border-solid border-oil-03">
        <img
          className="relative w-[50px] h-[50px] object-cover"
          alt="Thumbnails large"
          src="thumbnails-large-default-upload-bucket-wh1000xm4b-0002-003-a8a114c56c0e997c20a6d465e35d7103-2.png"
        />
      </div>
      <div className="inline-flex items-start gap-[10px] absolute top-[198px] left-[4px] bg-absolutestaticwhite-s rounded-[12px] border border-solid border-oil-03">
        <img
          className="relative w-[50px] h-[50px] object-cover"
          alt="Thumbnails large"
          src="thumbnails-large-default-upload-bucket-wh1000xm4b-0004-005-8ac91981a5234910dc9876bb8cd47082-1.png"
        />
      </div>
      <div className="flex w-[342px] items-center justify-between absolute top-[584px] left-0">
      ...
      <div className="flex flex-col w-[342px] items-start gap-[16px] absolute top-[425px] left-0">
        <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
          <div className="gap-[12px] inline-flex items-center relative flex-[0_0_auto]">
            ...
            <img src="https://i.postimg.cc/NjZnFBKm/document-svgrepo-com.png" className="relative w-[24px] h-[24px]" color="#0D0D0D" />
            </div>
          ...
          <img src="https://i.postimg.cc/SxrvL3Nt/right-arrow-svgrepo-com.png" className="relative w-[24px] h-[24px]" color="#0D0D0D" />
        </div>
        <img className="relative w-[325px] h-px object-cover" alt="Line" src="line-1.svg" />
        <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
          <div className="gap-[12px] inline-flex items-center relative flex-[0_0_auto]">
            <div className="justify-center gap-[10px] p-[9px] bg-[#f6eaec] rounded-[10px] inline-flex items-center relative flex-[0_0_auto]">
            <img src="https://i.postimg.cc/d0dxTpCX/colors-svgrepo-com.png" className="relative w-[24px] h-[24px]" color="#0D0D0D" />
            </div>
            <div className="relative w-fit [font-family:'Roboto-Regular',Helvetica] font-normal text-oil-11 text-[16px] tracking-[0] leading-[normal] whitespace-nowrap">
              Colors
            </div>
      ...
      <div className="flex flex-col w-[342px] items-start gap-[16px] absolute top-[317px] left-0">
        <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
